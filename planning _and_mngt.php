                    ...
                    <div class="single-news-active">
                        <div class="single-news-post">
                            <div class="news-post-img">
                                <img width="300px;" src="img/cisc.jpg" alt="theconstructo.com">
                            </div>
                            <div class="post-title">
                                <h2>PROJECT PLANNING AND MANAGEMENT SERVICE</h2>
                            </div>
                            <div class="row single-news-paddint">
                                <div class="col-md-12">
                                    <div class="about-list">
                                        <ul>
                                            <li>supervision, checking and technical approval of contractors' designs</li>
                                            <li>progress monitoring and chasing</li>
                                            <li>cost monitoring and cost control</li>
