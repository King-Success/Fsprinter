        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-5 text-left">
                    <div class="best-feature-title text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="section-title">
                        <h2>OUR TEAM</h2>
                        <p>Meet our team of highly qualified professionals.</p>
                        <div class="line">
                            <img src="img/line.png" alt="theconstructo.com">
                        </div>
                    </div>
                  ...
                  <div class="col-sm-4 text-center">
                    <div class="">
                        <div class="text-center">
                            <img src="img/oshodi%20(2).jpg" alt="theconstructo.com">
                            <div class="team-hover">
                                <a href="#" class="fa fa-link"></a>
                            </div>
                        </div><br>
                        <h3>OLAWUYI OLUTAYO DAVID</h3><br>
...
Olutayo has various training from Netherland, South Africa and within Nigeria as HP Accredited System Engineer, MCSE, CCNA, MPC, IBM Xseries Technician.</p>
                ...
                <div class="col-sm-4 text-center">
                    <div class="">
                        <div class="text-center">
                            <img  src="img/fatima.jpg" alt="theconstructo.com">
                            <div class="team-hover">
                                <a href="#" class="fa fa-link"></a>
                            </div>
                        </div><br>
                        <h3>AHAMINSI FATIMAH</h3><br>
                        <p  style="text-transform:uppercase;color: #e67817;" ><strong >Director Business Operation</strong></p>
                        <p>
Fatima provides the strategic direction for F.Sprinters Technologies, basing her leadership on her dual background in both internal project management and worldwide business development of the company. She has traveled wide and near. She has over 15 years working experiences in the oil field.</p>
                    </div>
                </div>
                <div class="col-sm-4 text-center">
                    <div class="">
                        <div class="text-center">
                            <img src="img/emma%20(2).jpg" alt="theconstructo.com">
                        </div><br>
...
Certificate of excellence for an outstanding performance in sustaining network 	availability KPI of above 99% by Airtel Nigeria Ltd.
                ...
                <div class="col-sm-4 text-center">
                    <div class="">
                        <div class="text-center">
                            <img src="img/annie%20(2).jpg" alt="theconstructo.com">
                            <div class="team-hover">
                                <a href="#" class="fa fa-link"></a>
                            </div>
                        </div><br>
...
Degree in Economics and a member of CIFIAN, Certificate in Networking, Certificate in Website Design. 
                  ...
                  <div class="col-sm-4 text-center">
                    <div class="">
                        <div class="text-center">
                            <img src="img/rohini%20(2).jpg" alt="theconstructo.com">
                            <div class="team-hover ">
                                <a href="#" class="fa fa-link"></a>
                            </div>
                        </div><br>
...
She has been instrumental in establishing strategies worldwide with the help of core professional team members.
                ...
                <div class="col-sm-4 text-center">
                    <div class="">
                        <div class="text-center">
                            <img src="img/anayo%20(1).jpg" alt="theconstructo.com">
                            <div class="team-hover">
                                <a href="#" class="fa fa-link"></a>
                            </div>
                        </div><br>
