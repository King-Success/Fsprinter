...
echo "<h3 style = 'color:red;'>Post Created <a style = 'font-size:15px;' href = '../gallary_post.php?p_id={$gal_id}'>View Post</a>  <a style = 'font-size:15px;' href = 'news.php?p_id={$gal_id}'>Edit More Posts</a></h3>";
}
